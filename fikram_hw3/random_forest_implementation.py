...
def run_wine():
    ...
    plot_forest_data(n_tree_dict_accuracy_average.keys(), n_tree_dict_accuracy_average.values(), "Wine Data ", "Accuracies")
    plot_forest_data(n_tree_dict_recall_average.keys(), n_tree_dict_recall_average.values(), "Wine Data ",  "Recall")
    plot_forest_data(n_tree_dict_precision_average.keys(), n_tree_dict_precision_average.values(), "Wine Data ", "Precision")
    plot_forest_data(n_tree_dict_f1_score_average.keys(), n_tree_dict_f1_score_average.values(), "Wine Data", "F1 Score")
    
    print("Wine Accuracies")
    print (n_tree_dict_accuracy_average)
    print("Wine Recall")
    print (n_tree_dict_recall_average)
    print("Wine Precision")
...
def run_house_votes():
    ...
    plot_forest_data(n_tree_dict_accuracy_average.keys(), n_tree_dict_accuracy_average.values(), "House84", "Accuracies")
    plot_forest_data(n_tree_dict_recall_average.keys(), n_tree_dict_recall_average.values(), "House84", "Recall")
    plot_forest_data(n_tree_dict_precision_average.keys(), n_tree_dict_precision_average.values(), "House84 ", "Precision")
    plot_forest_data(n_tree_dict_f1_score_average.keys(), n_tree_dict_f1_score_average.values(), "House84", "F1 Score")

    print("House Accuracies")
    print (n_tree_dict_accuracy_average)
    print("House Recall")
    print (n_tree_dict_recall_average)
    print("House Precision")
    print (n_tree_dict_precision_average)
    print("House F1 Score")
    print (n_tree_dict_f1_score_average)
