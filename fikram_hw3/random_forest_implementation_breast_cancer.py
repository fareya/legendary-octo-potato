...
def create_stratified_training_breast_cancer():

    house_votes_84 = pd.read_csv("datasets/hw3_cancer.csv", sep = "\t")
...
def run_breast_cancer():
    total_k = 10 
    chunks, label_col_name, _ = create_stratified_training_breast_cancer()
    ...
    plot_forest_data(n_tree_dict_accuracy_average.keys(), n_tree_dict_accuracy_average.values(), "Breast Cancer ", "Accuracies")
    plot_forest_data(n_tree_dict_recall_average.keys(), n_tree_dict_recall_average.values(), "Breast Cancer ", "Recall")
    plot_forest_data(n_tree_dict_precision_average.keys(), n_tree_dict_precision_average.values(), "Breast Cancer ", "Precision")
    plot_forest_data(n_tree_dict_f1_score_average.keys(), n_tree_dict_f1_score_average.values(), "Breast Cancer ", "F1 Score")

    print("Breast Cancer Accuracies")
    print (n_tree_dict_accuracy_average)
    print("Breast Cancer Recall")
    print (n_tree_dict_recall_average)
    print("Breast Cancer Precision")
    print (n_tree_dict_precision_average)
    print("Breast Cancer Score")
