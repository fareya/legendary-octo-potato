...
CATEGORICAL_COLS = ["WifeEducation", "HusbandEducation", "WifeReligion", "WifeWorking","HusbandOccupation", "LivingStandardIndex"]
BINARY_COLS = ["WifeReligion", "WifeWorking", "MediaExposure"]
CLASS_LABEL = " Method"
NUMERICAL_COLS = ["Age","NumberChildren"]
CATEGORICAL_COLS_DICT = {"WifeEducation":[1,2,3,4], 
...
def create_stratified_training_chunks_wine():
    wine_data = pd.read_csv("datasets/cmc.csv")
...
def run_wine():
    ...
    plot_forest_data(n_tree_dict_accuracy_average.keys(), n_tree_dict_accuracy_average.values(), " Contraceptive Method ", "Accuracies")
    plot_forest_data(n_tree_dict_recall_average.keys(), n_tree_dict_recall_average.values(), "Contraceptive Method ",  "Recall")
    plot_forest_data(n_tree_dict_precision_average.keys(), n_tree_dict_precision_average.values(), "Contraceptive Method ", "Precision")
    plot_forest_data(n_tree_dict_f1_score_average.keys(), n_tree_dict_f1_score_average.values(), "Contraceptive Method ", "F1 Score")
    
    print("Contraceptive Method Accuracies")
    print (n_tree_dict_accuracy_average)
    print("Contraceptive Method Recall")
    print (n_tree_dict_recall_average)
    print("Contraceptive Method Precision")
    print (n_tree_dict_precision_average)
    print("Contraceptive Method F1 Score")
